...
import { run as run2 } from "@grammyjs/runner";

// src/plugins/middlewares/concurrency.ts
import { sequentialize } from "@grammyjs/runner";
var sequentializePlugin = sequentialize((ctx) => {
...
var rateLimiterPlugin = rateLimiter({
  timeFrame: 2e3,
  // 2 seconds
  limit: 3,
  // 3 requests
...
var GrammyBot = class {
  ...
  async start(options = {}) {
    ...
    try {
      this._runner = run2(this.bot, options);
